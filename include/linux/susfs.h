...
#endif
#define CMD_SUSFS_HIDE_SUS_MNTS_FOR_NON_SU_PROCS 0x50017
/* Definizioni per SusFS v2.0.0 */
#define TASK_STRUCT_NON_ROOT_USER_APP_PROC (1UL << 28) // O il valore specifico della tua patch
#define INODE_STATE_SUS_KSTAT (1UL << 31)
...
#define INODE_STATE_OPEN_REDIRECT  (1UL << 29)
/**********/
/* STRUCT */
/**********/
